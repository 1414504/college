            ...
            if(mysqli_num_rows($result)>0)
            {
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    <div class = "row margin-top">
                        <div class="col-md-6">
                            <input value="<?php echo $row['college_name']; ?>" class="form-control">
                        </div>
                    ...
                    <div class="row margin-top">
                        <div class="col-md-6">
                            <input value="<?php echo $row['college_category']; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class = "row margin-top">
                        <div class="col-md-9">
                            <textarea class="form-control"> <?php echo $row['college_summary']; ?> </textarea>
                        </div>
